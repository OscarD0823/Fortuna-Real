...
export const gameGuides: Record<GameId, GameGuide> = {
  ...
  ducks: {
    ...
    badge: "BETA",
    beta: true,
    summary: "Los patos se esconden completamente entre bosque y pasto, salen en bandada y sobreviven con tres vidas.",
    steps: [
      { title: "Suelta la bandada", description: "Los participantes empiezan ocultos. Al iniciar, todos salen desde árboles, arbustos y pasto siguiendo rutas distintas.", action: "Pulsa Soltar los patos." },
      { title: "Apunta o usa acceso fácil", description: "Puedes disparar sobre el campo o registrar el siguiente impacto comprometido con teclado y controles accesibles.", action: "Un impacto revela el nombre y resta una vida." },
      { title: "Refugio y salida colectiva", description: "Después del impacto los patos se esconden por completo. Tras un tiempo aleatorio, toda la bandada vuelve a salir.", action: "Observa árboles, orilla y pasto inferior." },
...
export const guidedTours: Record<TutorialId, GuidedTourStep[]> = {
  ...
  ducks: [
    { target: ".duck-hunt__status", eyebrow: "PATOS · 1", title: "Comprueba la bandada", description: "La cabecera muestra participantes en pie, impactos, precisión y rendimiento del bosque 3D.", tip: "Todos empiezan con tres vidas." },
    { target: ".duck-hunt__arena", eyebrow: "PATOS · 2", title: "Bosque, pasto y refugios", description: "Los patos se ocultan completamente y reaparecen desde árboles, arbustos u orilla después de tiempos variables.", tip: "Cuando están escondidos no pueden quedar visibles." },
