...
export const gameGuides: Record<GameId, GameGuide> = {
  ...
  marbles: {
    ...
    badge: "BETA",
    beta: true,
    summary: "Una pista modular cuya longitud, altura, trampas y eventos crecen de verdad con la dificultad.",
    steps: [
      { title: "Define dificultad y llegada", description: "Elige Fácil, Media o Difícil y decide si cuenta la primera o la última canica. Puedes generar otro mapa mientras la ronda no esté sellada.", action: "Comprueba los controles antes de abrir la compuerta." },
      { title: "Escoge una cámara", description: "Vista general muestra toda la carrera. Persecución abre el encuadre y mira hacia delante; si hay una pista elevada, baja por el corredor inferior sin atravesarla. A bordo, Lateral y Aérea ofrecen otros ángulos.", action: "Elige un nombre o deja que el director estable siga la posición decisiva." },
      { title: "Observa poderes y eventos", description: "Turbo provoca más descontrol. Hielo, río, tornado y temblor aparecen durante el recorrido y afectan el movimiento.", action: "Mira la pista y el registro de eventos durante la carrera." },
      { title: "Recuperación y meta", description: "Si una canica abandona la pista vuelve de forma segura al inicio. La posición elegida decide quién gana o sale.", action: "Pulsa Iniciar carrera y sigue la clasificación." },
    ],
  },
  ducks: {
    title: "Patos 3D",
...
export const guidedTours: Record<TutorialId, GuidedTourStep[]> = {
  ...
  marbles: [
    ...
    { target: ".marble-arena", eyebrow: "CANICAS · 2", title: "Pista modular con niveles", description: "Puentes altos, curvas, túneles y zonas especiales forman un circuito distinto para cada semilla.", tip: "Una canica fuera de pista activa recuperación segura." },
    { target: ".marble-camera-control", eyebrow: "CANICAS · 3", title: "Mira la acción con contexto", description: "Persecución muestra la canica y el tramo que viene. En los cruces, la cámara detecta la pista superior y desciende por debajo sin atravesar la geometría.", tip: "El mapa gana separación horizontal y vertical según la dificultad; el director evita cambios bruscos." },
    { target: ".marble-power-quick-legend", eyebrow: "CANICAS · 4", title: "Entiende poderes y eventos", description: "Turbo aumenta el descontrol. Hielo, río, tornado y temblor afectan zonas aleatorias del recorrido.", tip: "El registro avisa cuando la posición seguida entra en un evento." },
